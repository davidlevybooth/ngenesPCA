...
# nifH
nifh_nh <- as.matrix(rnorm(3, mean=2.32e7, sd=0.02e7))
nifh_yl <- as.matrix(rnorm(3, mean=4.36e7, sd=0.10e7))
nifh_zl <- as.matrix(rnorm(3, mean=1.37e8, sd=0.06e8))
nifh_cl <- as.matrix(rnorm(3, mean=1.89e8, sd=0.05e8))
# AOB
aob_nh <- as.matrix(rnorm(3, mean=1.90e6, sd=0.05e6))
aob_yl <- as.matrix(rnorm(3, mean=4.58e6, sd=0.03e6))
aob_zl <- as.matrix(rnorm(3, mean=8.24e6, sd=0.04e6))
aob_cl <- as.matrix(rnorm(3, mean=6.13e6, sd=0.09e6))
# AOA
aoa_nh <- as.matrix(rnorm(3, mean=1.40e3, sd=0.01e3))
aoa_yl <- as.matrix(rnorm(3, mean=2.16e3, sd=0.02e3))
aoa_zl <- as.matrix(rnorm(3, mean=7.15e3, sd=0.01e3))
aoa_cl <- as.matrix(rnorm(3, mean=4.12e3, sd=0.03e3))
# nirK
nirk_nh <- as.matrix(rnorm(3, mean=3.56e5, sd=0.10e5))
nirk_yl <- as.matrix(rnorm(3, mean=7.45e5, sd=0.02e5))
nirk_zl <- as.matrix(rnorm(3, mean=1.39e6, sd=0.04e6))
nirk_cl <- as.matrix(rnorm(3, mean=2.48e6, sd=0.05e6))
# narG
narg_nh <- as.matrix(rnorm(3, mean=1.59e6, sd=0.02e6))
narg_yl <- as.matrix(rnorm(3, mean=5.37e6, sd=0.06e6))
narg_zl <- as.matrix(rnorm(3, mean=7.17e6, sd=0.04e6))
narg_cl <- as.matrix(rnorm(3, mean=1.60e7, sd=0.04e7))
